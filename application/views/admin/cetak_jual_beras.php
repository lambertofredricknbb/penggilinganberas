...
<head>
	<meta charset="utf-8">
	<title>Nota Penjualan Beras</title>
	<style>
		.alert {
		  height: 10px;
		  	...
		  	<div class="rowis">
		  		...
		  		<div class="colom" style="width: 50%; float: left;">
                    ...
                    ?>
				  	...
				  	<span style="font-family: sans-serif;">: <?= $d['nama_pembeli'] ?></span><br>
		  		</div>
		  	</div>
		  </div>
		  <div class="column">
		  	<div class="rowis">
		  		...
		  		<div class="colom" style="width: 50%; float: left;">
				  	<span>: <span style="font-size: 12pt; font-family: sans-serif; font-weight: 800; color: #fbc531;"><b><?= $d['kode_penjualan'] ?></b></span></span><br>
