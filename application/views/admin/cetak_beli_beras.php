...
<body>
	...
	<div class="box">
		<span style="text-align: center; font-weight: 800; font-family: sans-serif;"><b>NOTA PEMBELIAN BERAS</b></span>
	</div><br>
	<?php $i=1; foreach ($detail as $d): ?>
		<div class="row">
		  <div class="column">
		  	<div class="rowis">
		  		<div class="colom" style="width: 50%; float: left;">
		  			<span style="font-family: sans-serif;"><b>Tanggal Beli</b></span><br>
		  ...
		  <div class="column">
		  	<div class="rowis">
		  		<div class="colom" style="width: 50%; float: left;">
				  	<span style="font-family: sans-serif;"><b>Kode Pembelian</b></span><br>
		  		...
		  		<div class="colom" style="width: 50%; float: left;">
				  	...
				  	<span style="font-family: sans-serif;">: BERAS GILING</span><br>
		  		</div>
		  	</div>
		  </div>
		</div>
		...
		<table id="customers">
		  ...
		  <tr style="text-align: center;">
		    ...
		    <td><b><?= $d['musim'] ?> </b> <?= $d['nama_jenis'] ?> (GRADE <?= $d['nama_grade'] ?>)</td>
		    <td style="text-align: center;"><?= $d['tonase_beras'] ?> kg</td>
		    <td>Rp. <?= number_format($d['harga'], 0,'.','.') ?></td>
		  </tr>
		  <tr>
		    <th style="text-align: center;" colspan="2"><b>Total</b></th>
		    <th style="text-align: left;" colspan="1"><b><?= $d['tonase_beras'] ?> Kg</b></th>
