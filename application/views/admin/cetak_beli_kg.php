...
<body>
	...
	<div class="box">
		<span style="text-align: center; font-weight: 800; font-family: sans-serif;"><b>NOTA PEMBELIAN GABAH KG</b></span>
	</div><br>
	<?php $i=1; foreach ($detail as $d): ?>
		...
		<table id="customers">
		  ...
		  <tr>
		    ...
		    <th style="text-align: center;" colspan="1"><b>Rp. <?= number_format($d['harga_kg'], 0,'.','.') ?></b></th>
		    <th colspan="1"><b>Rp. <?= number_format($d['total'], 0,'.','.') ?></b></th>
		  </tr>
		</table><br>
		<div class="rowet">
