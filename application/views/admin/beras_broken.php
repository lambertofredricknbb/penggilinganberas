            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Beras Broken</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="card">
                <div class="card-header border-0">
                  <div class="row align-items-center">
                    <div class="col">
                      <h3 class="mb-0">Pembelian Beras Broken</h3>
                    </div>
                    <div class="col text-right">
                      <!--<a href="<?= base_url('admin/print_excel') ?>" class="btn btn-success"><i class="fas fa fa-print"></i> Cetak Laporan</a>-->
                      <?php if($user['level'] == 1): ?>
                      <a href="#" data-toggle="modal" data-target="#ModalTambah" class="btn btn-primary"><i class="fas fa fa-plus"></i> Tambah Beras</a>
                        <?php endif ?>
                      <!-- Modal -->
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row justify-content-left">
                                  <div class="col-md-12 text-left">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="">Jenis BROKEN</label>
                                             <select name="broken[]" required="" class="form-control" id="">
                                                <option value="1">Broken Menir</option>
                                                <option value="2">Broken Katul</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
    ...
    $(document).ready(function() {
            ...
            $(add_button).click(function(e) { //on add input button click
                ...
                if (x < max_fields) { //max input box allowed
                    ...
                    '<div class="col-md-3">' + 
                        '<label for="">Jenis Broken</label>' + 
                        '<select name="broken[]" id="grade' + x + '" required="" class="form-control" id="">' + '<option value="">Pilih</option>' +
